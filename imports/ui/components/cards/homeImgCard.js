    ...
    render() {
        return (
            <div className={"imgCardContainer " }>
                ...
                <div onMouseEnter={() => {this.animation('bigger')}} onMouseLeave={() => {this.animation('smaller')}} className={"card " + this.props.cardClass + ' ' + this.state.size} style={{backgroundImage:"url(" + this.props.image + ")", backgroundSize:'cover', backgroundPosition:'center' ,backgroundRepeat:"no-repeat"}} >
